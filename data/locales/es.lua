...
locale = {
  ...
  translation = {
    ...
    ["Hotkeys"] = "Hotkeys",
    ["If you shut down the program, your character might stay in the game.\nClick on 'Logout' to ensure that you character leaves the game properly.\nClick on 'Exit' if you want to exit the program without logging out your character."] = "Si se cierra el programa, su personaje puede permanecer en el juego.\nHaga clic en 'Desconectar' para asegurarse de que personaje deja el juego correctamente.\nHaga clic en 'Salir' si desea salir del programa igualmente, pudiendo mantener el personaje en el juego.",
    ["Ignore"] = "Ignorar",
    ...
    ["Name Report + Banishment"] = "Reporte de nombre + Baneo",
    ["Name Report + Banishment + Final Warning"] = "Reporte de nombre + Baneo + Último Aviso",
    ["No"] = "No",
