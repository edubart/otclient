locale = {
  ...
  translation = {
    ...
    ["1d) Name Inciting Rule Violation"] = "1d) Nome estimulando violação das regras",
    ...
    ["2f) Inciting Rule Violation"] = "2f) Estimulando violação das regras",
    ["3a) Bug Abuse"] = "3a) Abuso de falhas",
    ["3b) Game Weakness Abuse"] = "3b) Abuso de falhas do jogo",
    ...
    ["4b) Pretending to Have Influence on Rule Enforcement"] = "4b) Fingir ter influencia sobre a execução das regras",
    ...
    ["Alas! Brave adventurer, you have met a sad fate.\nBut do not despair, for the gods will bring you back\ninto this world in exchange for a small sacrifice\n\nSimply click on Ok to resume your journeys!"] = "Aventureiro, tu encontraste um destino triste.\nMas não desesperes, porque os Deuses vão trazer-te de volta\npara o mundo em troca de um pequeno sacrificio\n\nClica em Ok para voltar à tua jornada!",
    ["All"] = "Todos",
    ...
    ["Connecting to login server..."] = "Conectando ao servidor de autenticação...",
    ["Console"] = "Consola",
    ["Cooldowns"] = "Cooldowns",
    ...
    ["Don't stretch or shrink Game Window"] = "Não esticar ou contrair a janela do jogo",
    ...
    ["Enter one name per line."] = "Insera apenas um nome por linha.",
    ["Enter with your account again to update your client."] = "Entra com a tua conta novamente para atualizar o client.",
    ["Error"] = "Erro",
    ["Excessive Unjustified Player Killing"] = "Assassinato em excesso, sem justificação, de jogadores",
    ...
    ["Make sure that your client uses\nthe correct game protocol version"] = "Tenha certeza que o seu cliente usa\no mesmo protocolo do servidor do jogo",
    ["Mana"] = "Mana",
    ...
    ["No"] = "Não",
    ["No graphics card detected, everything will be drawn using the CPU,\nthus the performance will be really bad.\nPlease update your graphics driver to have a better performance."] = "Não foi detectada nenhuma placa de vídeo, os gráficos vão ser renderizados através do CPU,\no desempenho vai ser péssimo.\nAtualiza os drivers da placa de vídeo para aumentar o desempenho.",
    ...
    ["Reserved for more functionality later."] = "Reservado para maior funcionalidade no futuro.",
    ["Reset Market"] = "Resetar Mercado",
    ["Revoke %s's Invitation"] = "Não aceitar o convite do %s",
    ["Rotate"] = "Girar",
    ["Rule Violation"] = "Violação da regra",
    ["Save"] = "Salvar",
    ...
    ["Show connection ping"] = "Mostrar latência da conexão",
